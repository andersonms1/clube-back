...
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///app/node_modules/.pnpm/vue-bundle-renderer@2.1.1/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import destr from 'file:///app/node_modules/.pnpm/destr@2.0.5/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL } from 'file:///app/node_modules/.pnpm/ufo@1.6.1/node_modules/ufo/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///app/node_modules/.pnpm/unhead@2.0.5/node_modules/unhead/dist/server.mjs';
import { isVNode, toValue, isRef } from 'file:///app/node_modules/.pnpm/vue@3.5.13/node_modules/vue/index.mjs';
import { walkResolver } from 'file:///app/node_modules/.pnpm/unhead@2.0.5/node_modules/unhead/dist/utils.mjs';
import { renderToString } from 'file:///app/node_modules/.pnpm/vue@3.5.13/node_modules/vue/server-renderer/index.mjs';
...
import { createStorage, prefixStorage } from 'file:///app/node_modules/.pnpm/unstorage@1.15.0_db0@0.3.1_ioredis@5.6.1/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///app/node_modules/.pnpm/unstorage@1.15.0_db0@0.3.1_ioredis@5.6.1/node_modules/unstorage/drivers/fs.mjs';
...
import consola, { consola as consola$1 } from 'file:///app/node_modules/.pnpm/consola@3.4.2/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///app/node_modules/.pnpm/youch-core@0.3.2/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///app/node_modules/.pnpm/youch@4.1.0-beta.7/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///app/node_modules/.pnpm/source-map@0.7.4/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///app/node_modules/.pnpm/devalue@5.1.1/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///app/node_modules/.pnpm/errx@0.1.0/node_modules/errx/dist/index.js';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file:///app/node_modules/.pnpm/unhead@2.0.5/node_modules/unhead/dist/plugins.mjs';
...
const _xlS2F1ioxIGdLJ_8mehg9n5PD64SW7TLt7J9KvOV0vE = (function(nitro) {
...
const _1qIMWNVpSMwR2oaxlAWoL56lzt2g5AWL3VMQZjeug4A = (nitroApp) => {
...
const plugins = [
  _xlS2F1ioxIGdLJ_8mehg9n5PD64SW7TLt7J9KvOV0vE,
_1qIMWNVpSMwR2oaxlAWoL56lzt2g5AWL3VMQZjeug4A
];

const _lazy_N_A4C5 = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_N_A4C5, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_N_A4C5, lazy: true, middleware: false, method: undefined }
];
